...
PM_START_TEXT = """ 
────「 [{}](https://telegra.ph/file/ed54ab1effcfa96e4c82b.jpg) 」────
*ʜᴇʏ* {} , 🥀
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAIILmR4szNrDgPLwyzDVmF2Ms4M8liMAAIsCwACYiXAV0UtTAfU9I-SLwQ")
            x.delete()
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇꜱ",
                            url="https://t.me/Xd_Bots_Updates",
                        ),
                    ],
                    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/Xd_Bots_Updates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ᴛᴀᴛꜱᴜᴍᴀᴋɪ", url="https://t.me/tatsumaki_xD9"
                        ),
                    ],
                    [
